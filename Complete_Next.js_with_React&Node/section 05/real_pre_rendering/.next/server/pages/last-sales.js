...
module.exports = __webpack_require__("BR3j");
...
function LastSalesPage(props) {
  ...
  const {
    0: sales,
    1: setSales
  } = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(props.sales); // 컴포넌트가 로드 될때 url에 대한 요청을 보내게 된다
  // return 값을 받는다
  ...
  }, [data]); // 로딩보다 에러가 더 중요하기 때문에 앞서 두자
  ...
  return /*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])("ul", {
    children: sales.map(sale => /*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsxs"])("li", {
      children: [sale.username, " - $", sale.volume]
    }, sale.id))
  });
}
async function getStaticProps() {
  const res = await fetch("https://nextjs-prerender-d2499-default-rtdb.firebaseio.com/sales.json");
